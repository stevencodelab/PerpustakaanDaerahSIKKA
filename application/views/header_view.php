...
<head>
  ...
  <title><?php echo $title_web;?> | SISTEM INFORMASI PERPUSTAKAAN DAERAH KABUPATEN SIKKA </title>
...
<div class="wrapper">
  <header class="main-header">
    ...
    <a href="<?php echo base_url('index.php/dashboard');?>" class="logo">
      ...
      <span class="logo-lg">PERPUS SIKKA</span>
    </a>
        ...
        <ul class="nav navbar-nav">
          <li>
            ...
            <a href="<?= base_url('user/edit/'.$idbo);?>">
              Selamat Datang <?php echo $d->nama; echo ' | ( '.$d->level.' )'; ?></a>
          </li>
          <li class="dropdown messages-dropdown open">
